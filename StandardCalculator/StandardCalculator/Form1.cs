...
namespace StandardCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (cursorPos > 0)
            {
                expression = expression.Remove(cursorPos - 1, 1); // - 1 is the index of the number to remove, 1 is number of character to remove 
                cursorPos--; //decrement by 1
                RefreshDisplay();
            }
        }
